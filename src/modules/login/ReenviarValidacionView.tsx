...
const ReenviarValidacionView: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSuccess('');
    try {
      // Aquí deberías llamar a tu función de reenvío
      // await reenviarValidacion(email);
      setSuccess('Correo de validación reenviado');
    } catch (err) {
            ...
            <div>
              ...
              <form className="form-horizontal floating-labels" onSubmit={handleSubmit} autoComplete="off">
                ...
                <button
                  ...
                  disabled={loading}
                >
                  {loading ? 'Reenviando...' : 'REENVIAR VALIDACIÓN'}
                </button>
...
export default ReenviarValidacionView;
