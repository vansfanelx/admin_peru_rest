    ...
    .DataTable({
        ...
                    return '<div class="text-center"><span class="label label-success">APROBADO</span></div>';
            ...
            {"data":null,"render": function ( data, type, row ) {
                ...
                +'&nbsp;<button class="btn btn-sm btn-primary btn-imprimir-ingreso" data-json="'+htmlspecialchars(JSON.stringify(data))+'"><i class="fas fa-print"></i></button>'
                +'</div>';
            }}
        ],
...
// Handler para impresión robusto y seguro
$(document).on('click', '.btn-imprimir-ingreso', function() {
    ...
    var url = 'http://' + $('#pc_ip').val() + '/imprimir/ingreso.php?data=' + encodeURIComponent(JSON.stringify(data));
